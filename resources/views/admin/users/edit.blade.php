    ...
    <div class="row mt">
        <div class="col-lg-12">
            <div class="form-panel">
                ...
                {!! Form::open(['url' => $user->id ? route("admin.users.update", ['id' => $user->id ]) : route("admin.users.store"), 'class' => 'form-horizontal style-form']) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                        {!! \Form::select('role_id[]', $roles, array_values($user->roles->lists('id', 'id')), array('multiple'=>true, 'class' => 'form-control')) !!}
                        </div>
                    </div>
                    <div class="form-group">
