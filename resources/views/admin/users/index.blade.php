          ...
          <div class="col-md-12">
              <div class="content-panel">
                  <table class="table table-striped table-advance table-hover">
                      ...
                      <div class="col-md-6"><a href="{{ route('admin.users.create') }}" class="btn btn-theme" type="button">New user</a></div>
                      </div>
                      <hr>
                      @if (count($users))
                      <thead>
                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td>
                                  <a href="{{ route('admin.users.edit', ['id' => $user->id]) }}" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
  ...
  <script>
      $('[data-toggle="confirmation"]').confirmation({
        ...
        onConfirm: function() {
          ...
          $.post("{{ route('admin.users.destroy') }}", { id: user_id, _token: "{{ csrf_token() }}", '_method': 'delete' });
        }
      });
  </script>
  @stop
